 ...
 * @author eciacah
 */
public class KillRunningSetsCommandTest extends BaseMock {
  ...
  public void testPerformCommand() throws NumberFormatException, Exception {
    ...
    args[0] = "killRunningSets";
    args[1] = "DC_E_MGW";
    args[2] = "DC_E_CPP";
    args[3] = "DC_E_SGSN";

    KillRunningSetsCommand test = new KillRunningSetsCommand(args) {
    ...
    context.checking(new Expectations() {
      ...
      {
        one(mockedEngineAdmin).killRunningSets(with(any((List.class))));
      }
    });
  ...
  /**
   * engine -e killRunningSets DC_E_MGW should be allowed by
  ...
  public void testCheckNumberOfArguments_oneTP() {
     ...
     * killRunningSets DC_E_MGW Only killRunningSets
  ...
  /**
   * engine -e killRunningSets DC_E_MGW DC_E_SGSN should be
  ...
  public void testCheckNumberOfArguments_twoTPs() {
    /**
     * Set up array of arguments. For the command: engine -e
     * killRunningSets DC_E_MGW DC_E_SGSN Only
     * killRunningSets DC_E_MGW DC_E_SGSN will be passed in as
  ...
  /**
   * engine -e killRunningSets should be allowed by
   * checkNumberOfArguments().
   * 

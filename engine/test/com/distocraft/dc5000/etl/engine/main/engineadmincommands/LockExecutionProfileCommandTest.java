 ...
 *
 */
public class LockExecutionProfileCommandTest extends BaseMock {
    ...
    public void testPerformCommand() throws NumberFormatException, Exception {
        final String[] validNumberArguments = new String[] { "lockExecutionprofile" };
        final Command command = new StubbedLockExecutionProfileCommand(validNumberArguments);
    ...
    private void expectUnlockExecutionProfileCommandOnEngineAdmin() throws Exception {
        context.checking(new Expectations() {
            {
                one(mockedEngineAdmin).lockExecutionprofile();
            }
        });
    ...
    public void testCheckArgumentsWith2Arguments() {
        ...
        try {
            new LockExecutionProfileCommand(invalidNumberArguments).validateArguments();
            fail("Exception should have been thrown");
        } catch (final InvalidArgumentsException e) {
            assertThat(e.getMessage(),
                    is("Incorrect number of arguments supplied, usage: engine -e lockExecutionprofile"));
        }
    }
    ...
    public void testCheckArgumentsWithCorrectNumArgumentsDoesntThrowException() throws InvalidArgumentsException {
        ...
        final String[] validNumberArguments = new String[] { "lockExecutionprofile" };
        new LockExecutionProfileCommand(validNumberArguments).validateArguments();
    }

    class StubbedLockExecutionProfileCommand extends LockExecutionProfileCommand {

        /**
         * @param args
         */
        public StubbedLockExecutionProfileCommand(final String[] args) {
            super(args);
        }

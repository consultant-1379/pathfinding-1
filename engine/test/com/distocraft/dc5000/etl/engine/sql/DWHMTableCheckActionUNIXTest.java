...
/**
 * This class extends DWHMTableCheckActionTest. It is for running in UNIX. The parent class has some tests that fail on UNIX 
...
public class DWHMTableCheckActionUNIXTest extends DWHMTableCheckActionTest {
	
	//Overriding this method with the purpose of ignoring it
	
	@Test
	@Ignore
	public void testExecute() throws SQLException, RockException,

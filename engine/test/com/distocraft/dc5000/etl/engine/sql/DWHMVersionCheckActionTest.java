...
public class DWHMVersionCheckActionTest extends UnitDatabaseTestCase {
	     
	    private final static Logger clog = Logger.getLogger("DWHMVersionCheckAction");
	  ...
	  public void testConstructor() throws Exception{
		 try{
			 DWHMVersionCheckAction dvca = new DWHMVersionCheckAction(metaVersions,collectionSetId, collection, transferActionId, transferBatchId, connectId, 
		    		  etlrep, connectionPool, metaTransferActions, clog);
			 assertNotNull(dvca);
			} catch (Exception e) {
			    e.printStackTrace();
			    fail("DWHMVersionCheckActionTest() failed");
				}
	  } 

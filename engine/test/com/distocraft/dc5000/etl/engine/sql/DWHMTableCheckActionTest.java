...
public class DWHMTableCheckActionTest  extends UnitDatabaseTestCase {

	  private final Logger log = Logger.getLogger("DWHMTableCheckActionTest");
	  ...
	  public void testConstructor() throws EngineMetaDataException {
		try {  
			final DWHMTableCheckAction objUnderTest = new DWHMTableCheckAction(metaVersions,collectionSetId, collection, transferActionId, transferBatchId, connectId,
	  ...
	  public void testExecute() throws Exception{
			 boolean testDWHMTableCheckAction=false;
      final DWHMTableCheckAction objUnderTest = new DWHMTableCheckAction(metaVersions,collectionSetId, collection, transferActionId, transferBatchId, connectId,
		    		  etlrep, connectionPool, metaTransferActions,log);
		 try{
				objUnderTest.execute();
				testDWHMTableCheckAction=true;
				assertTrue(testDWHMTableCheckAction);
			} catch (Exception e) {
			    e.printStackTrace();
			    fail("DWHMTableCheckActionTest() failed");
				}
	  }

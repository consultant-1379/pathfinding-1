...
/**
 * This class extends SQLUpdateTest. It is for running in UNIX. The parent class has some tests that fail on UNIX 
...
public class SQLUpdateUNIXTest extends SQLUpdateTest {
	
	//Overriding this method with the purpose of ignoring it
	
	@Test
	@Ignore
	public void testExecuteSQLThroughJava() throws SQLException, RockException,
    ClassNotFoundException {
		try {
			super.testExecuteSQLThroughJava();
		} catch (Exception e) {

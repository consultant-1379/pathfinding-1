...
/**
 * This class extends SQLInsertTest. It is for running in UNIX. The parent class has some tests that fail on UNIX 
...
public class SQLInsertUNIXTest extends SQLInsertTest {
	
	//Overriding this method with the purpose of ignoring it
	
	@Test
	@Ignore
	public void testExecuteThroughJava() throws SQLException, RockException,
    ClassNotFoundException {
		try {
			super.testExecuteThroughJava();
		} catch (Exception e) {

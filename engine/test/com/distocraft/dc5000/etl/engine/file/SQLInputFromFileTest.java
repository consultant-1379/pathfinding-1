...
public class SQLInputFromFileTest extends UnitDatabaseTestCase {
  ...
  public void testConstructor() throws Exception {
	  try {	  
		  SQLInputFromFile siff = new SQLInputFromFile(metaVersions, 1L, collection, 1L, 1L, 1L, etlrep, connectionPool, metaTransferActions, batchColumnName);
	  }
	  catch(Exception e) {
  ...
  @Test
  public void testgetBatchColumnName() {
	  try {	  
		  SQLInputFromFile siff = new SQLInputFromFile(metaVersions, 1L, collection, 1L, 1L, 1L, etlrep, connectionPool, metaTransferActions, batchColumnName);
		  String actual = siff.getBatchColumnName();

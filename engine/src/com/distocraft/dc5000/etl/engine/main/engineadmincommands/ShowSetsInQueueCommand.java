 ...
 *
 */
public class ShowSetsInQueueCommand extends Command {

    /**
     * @param args
     */
    public ShowSetsInQueueCommand(final String[] args) {
        super(args);
    }
    ...
    String getUsageMessage() {
        return "showSetsInQueue or engine -e queue";
    }

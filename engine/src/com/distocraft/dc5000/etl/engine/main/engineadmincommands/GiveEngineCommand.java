 ...
 *
 */
public class GiveEngineCommand extends Command {
     ...
     * @param args
     */
    public GiveEngineCommand(final String[] args) {
        super(args);
    }
    ...
    String getUsageMessage() {
        return "giveEngineCommand command(string)";
    }
    ...
    public void performCommand() throws NumberFormatException, Exception {
        ...
        admin.giveEngineCommand(command);
    }

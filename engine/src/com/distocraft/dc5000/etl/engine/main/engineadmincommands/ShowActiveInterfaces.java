 ...
 *
 */
public class ShowActiveInterfaces extends Command {
	
    /**
     * @param args
     */
    public ShowActiveInterfaces(final String[] args) {
        super(args);
    }
	...
	String getUsageMessage() {
		return "engine -e showActiveInterfaces";
	}

 ...
 *
 */
public class RestartPriorityQueueCommand extends Command {

    /**
     * @param args
     */
    public RestartPriorityQueueCommand(final String[] args) {
        super(args);

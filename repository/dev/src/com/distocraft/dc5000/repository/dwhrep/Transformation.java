...
public class Transformation implements Cloneable,RockDBObject  {
    ...
    private boolean EXECUTIONLEVEL;
   
  private String timeStampName = "LAST_UPDATED"; // NOPMD : Dont set as static or final, unit tests change this via reflection

  private String[] columnsAndSequences = {  };

  private final String[] primaryKeyNames = {    "TRANSFORMATIONID"   };
   ...
   */
  public Transformation(final RockFactory rockFact   ,final String TRANSFORMATIONID  ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      if (it.hasNext()) {
        final Transformation o = it.next();
              ...
              this.EXECUTIONLEVEL=o.getEXECUTIONLEVEL();
   ...
   */
    ...
    sbuff.append("<Transformation ");
        ...
        sbuff.append("EXECUTIONLEVEL=\""+DataValidator.wrap(DataValidator.escapeXML(""+this.EXECUTIONLEVEL),12, true)+"\" ");
  ...
  public String toSQLInsert(){
    ...
    sbuff.append("insert into Transformation ( ");
	    		...
	    		sbuff.append(", TRANSFORMATIONID");
	    		sbuff.append(", TYPE");
	    		sbuff.append(", SOURCE");
	    		sbuff.append(", TARGET");
	    		sbuff.append(", CONFIG");
	    		sbuff.append(", DESCRIPTION");
	    		sbuff.append(", EXECUTIONLEVEL");
	        sbuff.append(" ) values ( ");
    	        ...
    	        sbuff.append(""+DataValidator.wrap(""+this.EXECUTIONLEVEL,12)+"");
    	    sbuff.append(" );\n");   
    return sbuff.toString();
  }
   ...
   public boolean getEXECUTIONLEVEL() {
  ...
  public void removeNulls() {
   ...
   public void setTransformationid(final String TRANSFORMATIONID) {
    if (validateData){
      DataValidator.validateData((Object)TRANSFORMATIONID,"TRANSFORMATIONID",12,255,0);
    }
    modifiedColumns.add("TRANSFORMATIONID");
    this.TRANSFORMATIONID = TRANSFORMATIONID;
  }
   public void setVersionid(final Long VERSIONID) {
	    if (validateData){
	      DataValidator.validateData((Object)VERSIONID,"VERSIONID",12,255,0);
	    }
   ...
   public void setEXECUTIONLEVEL(final boolean EXECUTIONLEVEL) {
	    if (validateData){
	      DataValidator.validateData((Object)EXECUTIONLEVEL,"EXECUTIONLEVEL",12,32000,0);
	    }
	    modifiedColumns.add("EXECUTIONLEVEL");
  ...
  //@SuppressWarnings({"PMD.SimplifyBooleanReturns", "PMD.SimplifyBooleanExpressions"})
	 ...
	 * 
	 * if ((((this.TRANSFORMATIONID == null) || (o.TRANSFORMATIONID == null)) &&
	 * (this.TRANSFORMATIONID != o.TRANSFORMATIONID)) || (((this.ORDERNO == null) ||
	 * (o.ORDERNO == null)) && (this.ORDERNO != o.ORDERNO)) ){ return false; } else
	 * if ((((this.TRANSFORMATIONID != null) && (o.TRANSFORMATIONID != null)) &&
	 * (this.TRANSFORMATIONID.equals(o.TRANSFORMATIONID) == false)) ||
	 * (((this.ORDERNO != null) && (o.ORDERNO != null)) &&
	 * (this.ORDERNO.equals(o.ORDERNO) == false)) ){ return false; } else { return
	 * true; } }
	 */
  ...
  public boolean equals(final Transformation o) {
         ...
         if ((((this.TRANSFORMATIONID == null) || (o.TRANSFORMATIONID == null)) && (this.TRANSFORMATIONID != o.TRANSFORMATIONID))
			...
			/*
			 * || (((this.EXECUTIONLEVEL == false) || (o.EXECUTIONLEVEL == false)) &&
			 * (this.EXECUTIONLEVEL!= o.EXECUTIONLEVEL))
			 */        ){
    return false;
    } else
         if ((((this.TRANSFORMATIONID != null) && (o.TRANSFORMATIONID != null)) && (this.TRANSFORMATIONID.equals(o.TRANSFORMATIONID) == false))
...
//  }
  ...
  * return 255
  */
  public static int getTransformationidColumnSize() {
  ...
  * return 0
  */
  public static int getTransformationidDecimalDigits() {
  ...
  * return 12
  */
  public static int getTransformationidSQLType() {

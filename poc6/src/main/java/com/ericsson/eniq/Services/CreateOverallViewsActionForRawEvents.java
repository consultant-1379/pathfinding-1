...
//     velocityContext.put("partitions", partitions);
     ...
     freeMarkerContext.put("baseTableName", timeRangeViewName);
    ...
    // mergeVelocityTemplateAndCreateView(RAW_TIME_RANGE_VIEW_TEMPLATE_FOR_DC, dwhrock, "overall view", velocityContext);
     mergeFreeMarkerTemplateAndCreateView(RAW_TIME_RANGE_VIEW_TEMPLATE_FOR_DC, dwhrock, "overall view", freeMarkerContext);
   }
 }

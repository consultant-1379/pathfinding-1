...
public class DatabaseDetails  implements ApplicationRunner {
	...
	private void init()
	{
		...
		dbDetails.put("dwhdbURL", env.getProperty("db.dwhdb.url"));
		dbDetails.put("dwhdbUser", env.getProperty("db.dwhdb.user"));
		dbDetails.put("dwhdbPass", env.getProperty("db.dwhdb.pass"));
		dbDetails.put("dwhDBAdbUser", env.getProperty("db.dbadwhdb.user"));
		dbDetails.put("dwhDBAdbPass", env.getProperty("db.dbadwhdb.pass"));
		dbDetails.put("dwhDBAdbURL", env.getProperty("db.dwhdb.url"));
